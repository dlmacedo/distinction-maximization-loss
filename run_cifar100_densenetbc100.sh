...
python main.py -ei="all" -et "train_classify" -ec "data~cifar100+model~densenetbc100+loss~dismax_std_std_fpr" -gpu 0 -x 10
...
python calibrate.py --dir all --dataset cifar100 --net_type densenetbc100 --loss dismax_std_std_fpr --gpu 0 -x 10
...
python detect.py --dir all --dataset cifar100 --net_type densenetbc100 --loss dismax_std_std_fpr --gpu 0 -x 10
...
#python verify.py --dir all --dataset cifar100 --net_type densenetbc100 --loss dismax_std_std_fpr --gpu 0 -x 10
