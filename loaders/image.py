...
class ImageLoader:
    ...
    def get_loaders(self):
        trainset_loader_for_train = DataLoader(
            self.trainset_for_train, batch_size=self.args.batch_size, shuffle=True, num_workers=0, worker_init_fn=lambda worker_id: random.seed(self.args.seed + worker_id))
