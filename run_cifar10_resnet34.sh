...
python main.py -ei="all" -et "train_classify" -ec "data~cifar10+model~resnet34+loss~dismax_std_std_fpr" -gpu 0 -x 5
...
python calibrate.py --dir all --dataset cifar10 --net_type resnet34 --loss dismax_std_std_fpr --gpu 0 -x 5
...
python detect.py --dir all --dataset cifar10 --net_type resnet34 --loss dismax_std_std_fpr --gpu 0 -x 5
...
#python verify.py --dir all --dataset cifar10 --net_type resnet34 --loss dismax_std_std_fpr --gpu 0 -x 5
